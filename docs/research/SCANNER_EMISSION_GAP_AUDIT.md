...
*Generated 2026-07-02T19:26:50.070281+00:00 · research-only, cache-only.*

## Question
Why did **499** liquid winners exist but only ~4 distinct tickers reach the long funnel/council?
...
| 2_liquidity_eligible | 2 | 0 | 0.0% | 499 | LIQUIDITY_FILTER |
| 3_base_universe_top1000 | 1000 | 343 | 68.7% | 0 | TOP_N_CAP (base limit 1000 by liquidity) |
| 4_long_strategy_universe | 138 | 34 | 6.8% | 309 | SCORE_GATE (voyager 0.35 / sniper 0.38 + structural filters) |
| 5_alpha_candidate_band | 320 | — | — | 0 | NOT_HISTORIZED (count-only; ticker list not persisted) |
| 6_alpha_board | 20 | 8 | 1.6% | 34 | TOP_N_CAP (board ≤20, 10/track) |
...
The discovery funnel is structurally narrow: liquidity-eligible winners (0) are cut to 343 by the top-1000 base-universe cap, then to 34 by the per-strategy score gates + structural filters (voyager 54 / sniper 90 names), and the council ultimately saw only 2 winners. The miss is an EMISSION/UNIVERSE gap upstream of the council — not a council/governance rejection.
