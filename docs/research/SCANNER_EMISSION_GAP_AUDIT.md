...
*Generated 2026-06-27T15:57:17.882024+00:00 · research-only, cache-only.*

## Question
Why did **489** liquid winners exist but only ~4 distinct tickers reach the long funnel/council?
...
| 2_liquidity_eligible | 2 | 0 | 0.0% | 489 | LIQUIDITY_FILTER |
| 3_base_universe_top1000 | 1000 | 346 | 70.8% | 0 | TOP_N_CAP (base limit 1000 by liquidity) |
| 4_long_strategy_universe | 138 | 26 | 5.3% | 320 | SCORE_GATE (voyager 0.35 / sniper 0.38 + structural filters) |
| 5_alpha_candidate_band | 320 | — | — | 0 | NOT_HISTORIZED (count-only; ticker list not persisted) |
| 6_alpha_board | 20 | 9 | 1.8% | 26 | TOP_N_CAP (board ≤20, 10/track) |
| 7_stock_lens_generated | 0 | 0 | 0.0% | 9 | MISSING_ARTIFACT |
| 8_gatekeeper_generated | 0 | 0 | 0.0% | 9 | MISSING_ARTIFACT |
| 9_council_veto_log | 30 | 2 | 0.4% | 26 | NO_EMISSION_PATH (scanner never emitted) |
...
The discovery funnel is structurally narrow: liquidity-eligible winners (0) are cut to 346 by the top-1000 base-universe cap, then to 26 by the per-strategy score gates + structural filters (voyager 54 / sniper 90 names), and the council ultimately saw only 2 winners. The miss is an EMISSION/UNIVERSE gap upstream of the council — not a council/governance rejection.
