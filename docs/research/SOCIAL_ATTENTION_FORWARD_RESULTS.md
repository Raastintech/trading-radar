...
- Generated: `2026-07-15T21:30:23.521424+00:00`
- History days: `24`
- Matured social-led (primary): `7`
- **Verdict: `NEED_MORE_DATA`** — history_days=24 (<10) or matured_social_led_primary=7 (<20); metrics shown are preliminary and must not drive routing.
