...
- Generated: `2026-07-16T21:30:22.991343+00:00`
- History days: `25`
- Matured social-led (primary): `7`
- **Verdict: `NEED_MORE_DATA`** — history_days=25 (<10) or matured_social_led_primary=7 (<20); metrics shown are preliminary and must not drive routing.
