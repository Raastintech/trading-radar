...
- Generated: `2026-07-07T21:30:26.183725+00:00`
- History days: `18`
- Matured social-led (primary): `7`
- **Verdict: `NEED_MORE_DATA`** — history_days=18 (<10) or matured_social_led_primary=7 (<20); metrics shown are preliminary and must not drive routing.
